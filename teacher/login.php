          ...
          <div class="divide-y divide-gray-200">
            <form action="POST">
              <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                <div class="relative">
                  <input value=email autocomplete="off" id="email" name="email" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900
            ...
            <a href="../admin/login.php" className="text-black hover:text-green-600 text-sm font-mono">
              Login as Admin
            </a>
          </div>
        </div>
